...
(2025). В обычном сборе режет по `sshr` из выдачи advanced-search до открытия карточки, в
госрежиме — по блоку карточки после гейта выручки. Источники без ССЧ (`ofdata`, `checko`,
