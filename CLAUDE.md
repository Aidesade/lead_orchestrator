...
py test_crm_push.py              # ВЕТКА outreach, стадия 9: маппинг в контракт CRM, сбой не летит наружу
