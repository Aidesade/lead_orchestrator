...
- state_owned=true, если просят новые государственные/муниципальные компании с
  фиксированным профилем: выручка >=2 млрд за 2025 год, подтверждённая прямая/косвенная
  госдоля >=25% (ровно 25% проходит), юрадрес — Республика Татарстан, без дублей CRM.
  Тогда industries, leads_json, min_revenue и region должны быть пустыми;
  count_total — итоговое N.
