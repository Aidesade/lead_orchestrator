...
PRODUCT = ("Telepatt — корпоративная LLM-платформа в защищённом on-premises контуре: "
...
HERO_KICKER = "Разработчик платформы Telepatt"
HERO_TITLE = "АО «ЦИТ РТ»"
HERO_LEAD = ("Государственный Центр информационных технологий Республики Татарстан — "
             "разработчик платформы Telepatt: корпоративная LLM-платформа в защищённом "
...
def build_user_content(company_name, industry="", pain="", contacts=None):
    ...
    lines += [
        ...
        "платформе Telepatt (справа: RAG-база / ИИ-агенты / ИИ-Коуч / on-premises). Опирайся "
